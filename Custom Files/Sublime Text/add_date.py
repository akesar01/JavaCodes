...
Header_Format and/or Date 20 May 2021 11:07:43AM,11:07:43ermair's answer on: https://stackoverflow.com/questions/28032780/automatic-update-date-in-sublime-by-save
...
class AddDateCommand(sublime_plugin.TextCommand):
    ...
    of the date-line (e.g. "L" if it's "// Last Edited: 20 May 2021 11:02AM38PM") and the end of the date-line (e.g. "M" if it's "// Last Edited:
    ...
    def run(self, args):
        ...
        Date_Format = time.strftime("%d %b %Y %I:%M:%S%p")
